...
from cnn_functions import make_training_data_fully_conv as make_training_data
...
file_name_save = os.path.join('/home/vanvalen/DeepCell/training_data_npz/HeLa/', 'HeLa_conv.npz')
